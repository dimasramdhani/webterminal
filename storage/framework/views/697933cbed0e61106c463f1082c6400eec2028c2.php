...
<html lang="en">
  ...
  <br>
  <br>
  <?php echo $__env->make('items.mod2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <br>
  <br>
  <?php echo $__env->make('items.atomizer2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <br>
  <br>
  <?php echo $__env->make('items.baterai2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <br>
  <br>
  <?php echo $__env->make('items.coil2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
