...
<html lang="en">
  ...
  <head>
    ...
    <title>Terminal Cileungsi</title>
  ...
  <body id="page-top">
  <!-- NAVIGATION -->
  <?php echo $__env->make('items.navigation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <!-- HEADER -->
  <?php echo $__env->make('items.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  
  <!-- SERVICES -->
  <?php echo $__env->make('items.service', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <!-- SERVICES -->
  <?php echo $__env->make('items.tarif', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  
 
  <!-- SERVICES -->
  <?php echo $__env->make('items.portfolio', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <!-- DOWNLOAD -->
